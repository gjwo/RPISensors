...
public class MPU9250Gyroscope extends Sensor3D 
{
	...
	public void printRegisters()
	{
	   	...
	   	ro.printShort(MPU9250Registers.XG_OFFSET_H);
	   	ro.printShort(MPU9250Registers.YG_OFFSET_H);
	   	ro.printShort(MPU9250Registers.ZG_OFFSET_H);
	   	ro.printShort(MPU9250Registers.GYRO_XOUT_H);
	   	ro.printShort(MPU9250Registers.GYRO_YOUT_H);
	   	ro.printShort(MPU9250Registers.GYRO_ZOUT_H);
	}
