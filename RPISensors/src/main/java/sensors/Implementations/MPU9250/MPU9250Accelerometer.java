...
public class MPU9250Accelerometer extends Sensor3D  {
	...
	{
		super.logState();
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_MAJOR_STATES, "accelScale: "+accelScale.toString()+ " minMax: "+accelScale.minMax+" Res: "+accelScale.getRes());
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_MAJOR_STATES, "accelSensitivity: "+accelSensitivity);
	}
	...
	{
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.ACCEL_CONFIG));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.ACCEL_CONFIG2));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.LP_ACCEL_ODR));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.SELF_TEST_X_ACCEL));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.SELF_TEST_Y_ACCEL));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringByteRegister(MPU9250Registers.SELF_TEST_Z_ACCEL));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.XA_OFFSET_H));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.YA_OFFSET_H));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.ZA_OFFSET_H));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.ACCEL_XOUT_H));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.ACCEL_YOUT_H));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_REGISTER_SUMMARIES, ro.logStringShort(MPU9250Registers.ACCEL_ZOUT_H));
	}
	...
	{
		SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"acc.configure");
        ...
        logState();
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"End acc.configure");
	}
	
	@Override
	public void selfTest() throws InterruptedException 
	{
		SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"acc.selfTest");
		byte FS = 0; 
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,"aAvg average: "+Arrays.toString(aAvg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,String.format(" [0x%X, 0x%X, 0x%X]%n", aAvg[0], aAvg[1], aAvg[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,"aSTAvg average: "+Arrays.toString(aSTAvg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X]%n", aSTAvg[0], aSTAvg[1], aSTAvg[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,"Self test Accel bytes: "+Arrays.toString(selfTestAccel));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X]%n", selfTestAccel[0], selfTestAccel[1], selfTestAccel[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,"factoryTrimAcc (float): "+Arrays.toString(factoryTrimAccel));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.USER_INFORMATION,"Accelerometer accuracy:(% away from factory values)");
        SystemLog.log(this.getClass(),SystemLog.LogLevel.USER_INFORMATION,"x: " + AccuracyAccel[0] + "%");
        SystemLog.log(this.getClass(),SystemLog.LogLevel.USER_INFORMATION,"y: " + AccuracyAccel[1] + "%");
        SystemLog.log(this.getClass(),SystemLog.LogLevel.USER_INFORMATION,"z: " + AccuracyAccel[2] + "%");
        ro.writeByte(MPU9250Registers.ACCEL_CONFIG, (byte)(	AccSelfTest.NONE.bits |	// no self test
																AccScale.AFS_2G.bits));	// Set scale range for the accelerometer to 2 g 
        ro.writeByte(MPU9250Registers.ACCEL_CONFIG2, A_DLPF.F1BW0099_2.bits);	// Set accelerometer rate to 1 kHz and bandwidth to 99 Hz
        Thread.sleep(25); // Delay a while to let the device stabilise
        logState();
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"End acc.selfTest");
	}
	...
	public void calibrate() throws InterruptedException
	{
		...
		SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"accel.calibrate");
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Scaling: "+getDeviceScaling().toString());
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Bias: "+getDeviceBias().toString());
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Accel Bias sum: "+Arrays.toString(accelBiasSum));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X]%n",accelBiasSum[0],accelBiasSum[1],accelBiasSum[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Accel sample count: " + sampleCount);
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Accel bias average: " + Arrays.toString(accelBiasAvg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X]%n",accelBiasAvg[0],accelBiasAvg[1],accelBiasAvg[2]));
        ...
        this.setDeviceBias(new Data3f( 	(float)accelBiasAvg[0]/2.0f/(float)accelSensitivity,
         ...
         logState();
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERFACE_METHODS,"End accel.calibrate");
	}
    void setHardwareBiases(short[] biasAvg)
    {
    	...
    	SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERNAL_METHODS,"setAccelerometerBiases");
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "accelBiasReg with temp compensation bit: "+Arrays.toString(accelBiasReg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X] %n",accelBiasReg[0],accelBiasReg[1],accelBiasReg[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "Temperature bits"+Arrays.toString(mask_bit));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "accelBiasReg without temp compensation bit: "+Arrays.toString(accelBiasReg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, String.format(" [0x%X, 0x%X, 0x%X] %n",accelBiasReg[0],accelBiasReg[1],accelBiasReg[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES, "(accelBiasReg - biasAvg/8)*2 + TCbit (16bit): "+Arrays.toString(accelBiasReg));
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_VARIABLES,  String.format(" [0x%X, 0x%X, 0x%X] %n",accelBiasReg[0],accelBiasReg[1],accelBiasReg[2]));
        ...
        SystemLog.log(this.getClass(),SystemLog.LogLevel.TRACE_INTERNAL_METHODS,"End setAccelerometerBiases");
    }
}